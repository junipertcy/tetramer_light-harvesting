function [Reg Reintcf Retcf Img Imintcf Imtcf]=bath_construction(J, F, KbT, t_max, dtg, dtt) 
%This function constructs the bath for simulation. The output includes the
%real parts and imaginary parts of lineshape function (g), time correlation
%function first integral (intcf), and time correlation function (tcf)
...
%t_max: the maximum time calculated for the bath, depencing on the coupling
